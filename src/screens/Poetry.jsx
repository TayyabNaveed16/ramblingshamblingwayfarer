...
function Poetry() {
  return (
    <div className="bg-whitesmoke overflow-x-hidden">
      ...
      <section className="black relative pt-32 mt-48 justify-center items-center">
        ...
        <div class="custom-shape-divider-top-1708767574">
          <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
        ...
        <h1 className='text-4xl text-white antialiased pb-40 pt-40  underline-offset-2 text-center	decoration-double'>More Coming Soon!</h1>
